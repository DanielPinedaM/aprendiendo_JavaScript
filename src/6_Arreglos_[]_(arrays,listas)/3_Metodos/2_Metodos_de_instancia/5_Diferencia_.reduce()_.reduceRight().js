...
Resumen: Diferencia Entre .forEach() .map() .filter() .reduce() .find()
             ...
             |                  |                                 |                               |                                                  | y su copia array2                |                                                                                    |
|------------|------------------|---------------------------------|-------------------------------|--------------------------------------------------|----------------------------------|------------------------------------------------------------------------------------|
| .forEach() | ✔️                | X                               | ✔️                             | X                                                | X                                | ['▲', '●', '✖', '■'].forEach((elemento, i) => {                                   |
...
|            |                  |                                 |                               |                                                  |                                  | // i=3 | elemento='■'                                                              |
|------------|------------------|---------------------------------|-------------------------------|--------------------------------------------------|----------------------------------|------------------------------------------------------------------------------------|
| .map()     | ✔️                | ✔️                               | X                             | ✔️                                                | array1.length                    | En el array1 original (existente)                                                  |
...
|            |                  |                                 |                               |                                                  |                                  | // (4) ['■▲', '■▲', '■▲', '■▲']                                                    |
|------------|------------------|---------------------------------|-------------------------------|--------------------------------------------------|----------------------------------|------------------------------------------------------------------------------------|
| .filter()  | ✔️                | ✔️                               | X                             | ✔️                                                | array1.length                    | En el array1 original (existente)                                                  |
...
|            |                  |                                 |                               |                                                  |                                  | // (3) ['■', '■', '■']                                                             |
|------------|------------------|---------------------------------|-------------------------------|--------------------------------------------------|----------------------------------|------------------------------------------------------------------------------------|
| .reduce()  | ✔️                | X                               | X                             | ✔️                                                | UN SOLO VALOR                    | Concatenar (unir)                                                                  |
...
|------------|------------------|---------------------------------|-------------------------------|--------------------------------------------------|----------------------------------|------------------------------------------------------------------------------------|
| .find()    | ✔️                | X                               | X                             | ✔️                                                | X                                | Devolver el PRIMER elemento q sea un círculo '●'                                   |
